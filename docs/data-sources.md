...
| --- | --- | --- | --- | --- | --- |
| Deni Avdija | Verified | NBA player profile | ESPN NBA 2025-26 regular-season statistics, identity- and season-bound to ESPN player `4683021` | None approved | Scheduled snapshot, not live play-by-play |
| Ben Saraf | Verified | NBA G League player profile | ESPN NBA 2025-26 regular-season statistics, identity- and season-bound to ESPN player `5242502` | None approved | Scheduled snapshot, not live play-by-play |
| Oscar Gloukh | Verified | Ajax first-team profile | None published | None approved | Identity-only until a suitable statistics source is connected |
